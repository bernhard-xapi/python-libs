...
def set_warnings():
    ...
    Using setenv:PYTHONWARNINGS=ignore in tox.ini,
    we disable the Deprecation warnings caused by pytest plugins.
    This fixture enables the default warnings filter to
    not filter the default warnings (e.g. ResourceWarning).

    During interactive pytest use, this default warning filter
    also provides checking of ResourceWarning:
    """
